...
<body class="bg-green-100 flex items-center justify-center h-screen">
    <div class="text-center">
        ...
        <!-- Kode Error -->
        <h1 class="text-9xl font-bold text-green-700 animate-bounce">500</h1>

        <!-- Pesan Utama -->
        <p class="text-2xl font-semibold text-gray-700 mt-4">Oops! Terjadi Kesalahan pada Server.</p>
        <p class="text-gray-500 mt-2">Kami sedang memperbaiki masalah ini. Silakan coba lagi nanti.</p>
