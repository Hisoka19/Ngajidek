<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="age" class="block mt-1 w-full" type="number" name="age" :value="old('age')" required autocomplete="age" min="1" />
            <x-input-error :messages="$errors->get('age')" class="mt-2" />
        </div>

        <!-- Nomer Whatsapp -->
        <div class="mt-4">
            <x-input-label for="whatsapp" :value="__('Nomer Whatsapp')" />
